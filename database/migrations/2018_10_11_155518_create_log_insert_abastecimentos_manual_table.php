...
class CreateLogInsertAbastecimentosManualTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('log_abastecimentos_manual', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('log_abastecimentos_manual');
    }
}
