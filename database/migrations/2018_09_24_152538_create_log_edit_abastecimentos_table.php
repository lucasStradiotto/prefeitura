...
class CreateLogEditAbastecimentosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('log_edit_abastecimentos', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('log_edit_abastecimentos');
    }
}
